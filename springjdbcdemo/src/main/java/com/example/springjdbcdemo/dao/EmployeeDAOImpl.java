...
public class EmployeeDAOImpl implements EmployeeDAO
{
    ...
    public int save(Employee employee) {
       return jdbcTemplate.update("INSERT INTO public.tbl_employees (id,name,email,department) VALUES(?,?,?,?)", new Object[]{employee.getId(),employee.getName(),employee.getEmail(),employee.getDepartment()});
    }
    @Override
